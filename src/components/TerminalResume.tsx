...
const RESUME_DATA = {
    ...
    judgment: "追求“第一性原理”的产品构建者。拒绝知识幻觉，提倡对抗性学习。擅长资源错位下的差异化战略分析。",
    fastFacts: [
            ...
            items: [
                {
                    ...
                    points: [
                        'AI Agent 判准与行研：撰写《中国AI Agent投资机会分析报告》，明确“自主执行与任务闭环”为 Agent 核心评判标准，区分“高能力 Chatbot”与“任务驱动型 Agent”的商业交付价值。',
                        '讯飞战略差异化研究：论证其利用“软硬一体+私有化部署”避开公有云基础设施劣势、满足隐私刚需的必然性，准确预判其利润释放周期。',
                        '全流程招聘统筹：负责投资团队实习生全生命周期招聘，完成 28 份简历筛选与精准匹配，成功转化 2 名高匹配人才入职。'
                    ]
                },
                {
                    heading: '招商银行泉州分行战略部',
                    ...
                    points: [
                        '业务框架构建：快速掌握对公金融业务认知，梳理债券发行、保理等对公融资工具底层逻辑。',
                        '财务穿透：识别国企项目账面亏损实为大额折旧，透视企业底层真实造血能力。',
                        '尽调协助：抓取复杂业务合同关键要素，独立绘制基础股权结构图。'
                    ]
                }
            ]
        },
        {
            title: 'PROJECTS_&_BUILD',
            icon: Layers,
            items: [
                {
                    heading: 'Recall Sticker - 认知强化学习工具',
                    sub: 'Product Logic & AI Integration',
                    time: '2026',
                    points: [
                        '对抗知识幻觉：基于主动回想（Active Recall）原理设计遮蔽机制，强制用户从被动阅读转为主动建构。',
                        'AI 语境优化：探索利用 LLM 识别用户标注意图，自动抽取与补全上下文语境，解决复习过程中的信息碎片化问题。',
                        'Badcase 洞察：识别并试图解决“过度标注”导致的整理负荷（Curation Mess），通过 Vibe Coding 快速迭代响应式界面。'
                    ]
                }
            ]
        },
            ...
            items: [
                {
                    ...
                    points: [
                        '近一年总绩点排名专业前 5%；校优秀学生、国家三级运动员。',
                        '2024 全国高校商业精英挑战赛商务谈判竞赛总决赛一等奖（任技术顾问，负责利用梯度阶梯量化风控指标）。',
                        '2024 全国营销模拟决策赛道全国决赛二等奖（搭建动态定价模型分析 MR/MC 关系）。'
                    ]
                }
            ]
        }
...
export const TerminalResume: React.FC = () => {
    return (
        <div className="min-h-screen bg-[#0F110C] text-[#D1D5DB] font-mono selection:bg-[#3E4C31] selection:text-[#E2E8F0] p-4 md:p-10 relative overflow-hidden text-left">
            ...
            <div className="max-w-5xl mx-auto border border-[#3E4C31]/30 bg-[#161B13]/40 backdrop-blur-md p-8 md:p-12 shadow-[0_0_60px_rgba(0,0,0,0.6)] relative">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start gap-8">
                        <div className="flex-1">
                            <div className="text-[#6A9BCC] mb-2 text-[10px] tracking-[0.4em] uppercase opacity-70">
                                <Typewriter text="System.Active_Recall_Initiated" />
                            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    <aside className="lg:col-span-3 space-y-8 order-last lg:order-first">
                        <div className="p-5 rounded-2xl border border-[#3E4C31]/30 bg-[#3E4C31]/5">
                            ...
                            <p className="text-[11px] leading-relaxed font-serif text-[#D1D5DB]/80 italic text-left">
                                            ...
                                            <div key={i} className="relative">
                                                ...
                                                <ul className="space-y-2.5">
                                                    {item.points.map((p, pi) => (
                                                        <li key={pi} className="text-[13px] text-[#D1D5DB]/90 font-serif leading-relaxed flex gap-3 text-left">
                ...
                <footer className="mt-16 pt-6 border-t border-[#3E4C31]/10 text-[9px] text-[#A0AEC0]/30 flex justify-between font-mono tracking-[0.2em]">
                    <div className="flex items-center gap-4">
                        <span>BUILD_VERIFIED_APR_2026</span>
                        <span className="animate-pulse text-[#788c5d]">● TRUTHFULNESS_STABLE</span>
                    </div>
                    <span>RESUME.YISHUZIYU.CN // RECALL_STRICT</span>
                </footer>
            </div>
        </div>
    );
